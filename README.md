...
---
*Última actualización: 10/09/2026 — V2 + RF-01/02/25 + IDE fix + cSpell + RF-03/04/05 DONE + RF-06 base+pulido DONE + RF-08/09/11/10/13 DONE + RF-07 DONE + RF-12 DONE + RF-14 serie mensual DONE + RF-15 mapa DONE + RF-16 clic-filtra DONE + RF-18 búsqueda DONE + RF-19 banderas DONE (umbral 30→10, 50 recalcula, abc 400) — Sprint 4 iniciado — Siguiente: RF-20 predominio directa / RF-24 umbrales admin — Autor: Steven Araque + Jarvis ⚡*
