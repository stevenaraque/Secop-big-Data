"""
Django settings for secop_backend project.
...
# CORS/CSRF por env — local + Vercel prod sin hardcodear
...
ROOT_URLCONF = 'secop_backend.urls'
...
WSGI_APPLICATION = 'secop_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'secop_db'),
...
# Email — RF-41 SaaS: console en dev, SMTP real en prod via .env
