...
const MoltenMetal = ({
  ...
  lightMode = false,
  // SECOP: tope de DPR propio (default = comportamiento original).
  // A pantalla completa, dpr 2 funde la GPU; 1.25 rinde igual de bien.
  dpr = null,
  className = ''
}) => {
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      antialias: false,
      dpr: Math.min(window.devicePixelRatio || 1, dpr ?? 2)
    });
